...
namespace BananaSongTest
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("SearchForYouTubeBannanaSongUsingGoogle", Description="In order to validate views quantity for bannana song\r\nAs a basic User \r\nI want to" +
        " search for bannana song using Google", SourceFile="SearchForYouTubeBannanaSongUsingGoogle.feature", SourceLine=0)]
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("Search for YouTube song using Google", new string[] {
                "bannanasong"}, SourceLine=7)]
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("Validate the views quantity", SourceLine=13)]
